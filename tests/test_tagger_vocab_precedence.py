"""Tests for scripts.anima_tagger.vocab caption scanning.
...
from library.captioning.tag_rules import TagRules
from scripts.anima_tagger.vocab import build_caption_index, find_caption_files
