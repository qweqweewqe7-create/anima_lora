...
``docs/proposal/curation_repo_split.md`` §"Model-path resolution"):
...
3. The checkout root containing this file (``anima_lora/`` today).

Inside the trainer all three coincide, so behaviour is unchanged.
"""
